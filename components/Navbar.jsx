  ...
  return (
    <div>
      ...
      <nav className="navbar navbar-expand-lg navbar-blue navbar-b bg-primary">
        ...
        {/* <button className="btn btn-blue  mx-2"  href="./AddEmployee.js">Add Employee </button>
        <button className="btn btn-blue  mx-2"  href="./UpdateEmp.js">Edit Employee </button>
        <button className="btn btn-blue  mx-2"  href="./Login.js">Update Employee </button>
           */}
        <Link className="btn btn-blue mx-2 shadow-lg" to="/AddEmployee">
         Registration
        </Link>
